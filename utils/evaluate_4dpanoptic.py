...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      type=str,
      #required=True,
      default='test/Log_2022-06-17_12-16-59_importance_None_str1_bigpug_4_current_chkp/stitch4', 
      ...
      if corresponding_pred_instances.shape[0] > 1:
        ...
        for key in dict:
          if dict[key] < 500:
            do_print = False
        if do_print:
          logger.info(label_file + " Instance: " + str(instance) + " (" + str(instance_ids.shape[0]) + ") " + ", divided into " + str(corresponding_pred_instances.shape[0]) + ", " + str(dict))
      ...
      if corresponding_gt_instances.shape[0] > 1:
        ...
        for key in dict:
          if dict[key] < 500:
            do_print = False
        if do_print:
          logger.info(label_file + " Instances: " + str(dict) + ", merged into " + str(instance) + " (" + str(instance_ids.shape[0]) + " )")
  ...
  logger.info("100%")
  logger.info('FP: ' + str(false_positive_count_summed))
  logger.info('FN: ' + str(false_negative_count_summed))
